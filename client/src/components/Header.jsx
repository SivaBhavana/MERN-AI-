...
import sample_img1 from '../assets/sample_img_1.png'
import sample_img2 from '../assets/sample_img_2.png'
...
>
      ...
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'
       ...
       >Generate Images 
               <img className='h-6' src={star_group} />
        </motion.button>
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                <motion.img className='rounded hover:scale-105 transition-all duration-300 curson-pointer max-sm:w-10' 
                whileHover={{scale:1.05,duration:0.1 }}
                src={index % 2 === 0 ? sample_img2 : sample_img1 }
