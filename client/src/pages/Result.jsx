...
import sample from '../assets/sample_img_1.png';
...
const Result = () => {
    ...
    return (
        ...
        >
            ...
            {/* Show input field and Generate button initially */}
            {!isImageLoaded && (
            ...
            {/* Show Generate Another & Download buttons after image is generated */}
            {isImageLoaded && (
